class Product {
    ...
    AddToList() {
        ...
        document.getElementById("productList").insertAdjacentHTML("beforeend", this.code);
    ...
    Notificar(missatge, classe) {
        ...
        */
            document.getElementById("areaNotificacions").innerHTML = `<div class="alert ` + `alert-${classe}` + ` alert-dismissible">
